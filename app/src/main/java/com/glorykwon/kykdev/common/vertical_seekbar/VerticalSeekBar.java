package com.glorykwon.kykdev.common.vertical_seekbar;
...
//    public HSVerticalSeekBar(Context context) {
//        super(context);
//    }
//
//    public HSVerticalSeekBar(Context context, AttributeSet attrs, int defStyle) {
//        super(context, attrs, defStyle);
//    }
//
//    public HSVerticalSeekBar(Context context, AttributeSet attrs) {
//        super(context, attrs);
//    }
//
